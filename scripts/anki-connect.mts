...
const MODEL_CSS = [
  ".card { box-sizing: border-box; max-width: 760px; margin: 0 auto; padding: 22px; background: #f3f7fb; color: #10283f; font-family: Inter, Aptos, 'Segoe UI', Arial, sans-serif; font-size: 18px; line-height: 1.5; text-align: left; }",
  ".omed-card { overflow: hidden; border: 1px solid #cadbe6; border-top: 5px solid #126f99; border-radius: 18px; padding: clamp(20px, 5vw, 36px); background: #ffffff; box-shadow: 0 16px 42px rgba(16, 40, 63, .10); }",
  ".omed-header { margin-bottom: 18px; }",
  ".omed-badge { display: inline-flex; max-width: 100%; border-radius: 999px; padding: 6px 11px; background: #dff2f7; color: #0d587b; font-size: 12px; font-weight: 800; letter-spacing: .08em; line-height: 1.25; text-transform: uppercase; }",
  ".omed-question { font-size: clamp(21px, 4vw, 29px); font-weight: 750; letter-spacing: -.02em; line-height: 1.3; }",
  ".omed-question-back { color: #50697e; font-size: 15px; font-weight: 650; line-height: 1.4; }",
  ".omed-hint { margin-top: 24px; color: #6d8294; font-size: 12px; font-weight: 650; letter-spacing: .04em; }",
  ".omed-divider { height: 1px; margin: 20px 0; background: #cadbe6; }",
  ".omed-answer { color: #10283f; font-size: clamp(18px, 3vw, 23px); font-weight: 650; line-height: 1.48; }",
  ".omed-ref { margin-top: 22px; border-left: 3px solid #61c7e2; padding: 9px 12px; background: #edf4f8; color: #50697e; font-size: 12px; line-height: 1.45; }",
  "img { display: block; max-width: 100%; max-height: 68vh; margin: 18px auto; border-radius: 12px; object-fit: contain; }",
  ".cloze { color: #126f99; font-weight: 800; }",
