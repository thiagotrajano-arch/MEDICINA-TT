...
export function AgendaPrivadaClient({ disciplinas }: { disciplinas: Disciplina[] }) {
  ...
  if (autenticado === null) return <div className="mx-auto max-w-5xl px-5 py-12 text-sm text-text-muted">Verificando sua sessão...</div>;
