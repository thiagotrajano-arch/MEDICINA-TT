...
export const FIGURAS: Record<string, Figura> = {
  ...
  "inf-meningococcemia-purpura-real": { id: "inf-meningococcemia-purpura-real", titulo: "Meningococcemia — púrpura fulminante", legenda: "Necrose cutânea extensa e simétrica por púrpura fulminante em lactente com meningococcemia, refletindo coagulação intravascular disseminada; achado que exige reconhecimento imediato. Imagem clínica explícita.", imagem: { src: "img/clinicas/meningococcemia-purpura.jpg", alt: "Lactente com necrose cutânea extensa em mãos e antebraços por púrpura fulminante em meningococcemia; imagem clínica explícita", fonte: "Wikimedia Commons", licenca: "CC BY-SA 3.0", autor: "Pam Cleverley e Perry Bisman (babycharlotte.co.nz)", url: "https://commons.wikimedia.org/wiki/File:Charlotte_Cleverley-Bisman_Meningicoccal_Disease.jpg" } },
  "inf-erisipela-real": { id: "inf-erisipela-real", titulo: "Erisipela", legenda: "Placa eritematosa, edemaciada e de bordas bem delimitadas em perna, característica da erisipela — infecção de derme superficial e linfáticos, tipicamente por Streptococcus pyogenes.", imagem: { src: "img/clinicas/erisipela-perna.jpg", alt: "Perna com placa eritematosa e edemaciada de bordas bem delimitadas, compatível com erisipela", fonte: "Wikimedia Commons", licenca: "CC0", autor: "Mikael Häggström", url: "https://commons.wikimedia.org/wiki/File:Recurrent_erysipelas_on_edematous_leg.jpg" } },
  "cir-isquemia-mesenterica-tc-real": { id: "cir-isquemia-mesenterica-tc-real", titulo: "Isquemia mesentérica — tomografia", legenda: "Alça intestinal dilatada com espessamento de parede em paciente com trombose de veia mesentérica superior, achado tomográfico de isquemia mesentérica.", imagem: { src: "img/clinicas/isquemia-mesenterica-tc.png", alt: "Tomografia de abdome mostrando alça intestinal dilatada e espessada por isquemia mesentérica", fonte: "Wikimedia Commons", licenca: "CC BY-SA 3.0", autor: "James Heilman, MD", url: "https://commons.wikimedia.org/wiki/File:Ischemicbowel.PNG" } },
  "endocrino-bocio-real": { id: "endocrino-bocio-real", titulo: "Bócio", legenda: "Aumento de volume cervical por bócio de longa evolução. Fotografia histórica (1886–87); o achado clínico de aumento tireoidiano permanece válido.", imagem: { src: "img/clinicas/bocio-clinico.jpg", alt: "Fotografia histórica de homem com bócio cervical volumoso", fonte: "Wellcome Collection via Wikimedia Commons", licenca: "CC BY 4.0", autor: "St Bartholomew's Hospital / Wellcome Collection", url: "https://commons.wikimedia.org/wiki/File:Man_with_goitre_which_had_existed_for_many_years_Wellcome_L0061721.jpg" } },
  "clm-ictericia-escleral-real": { id: "clm-ictericia-escleral-real", titulo: "Icterícia escleral", legenda: "Icterícia escleral evidente em paciente internado por complicações de hepatite aguda — sinal clínico de hiperbilirrubinemia.", imagem: { src: "img/clinicas/ictericia-escleral.jpg", alt: "Esclera com coloração amarelada evidente por icterícia", fonte: "Wikimedia Commons", licenca: "CC BY 4.0", autor: "Sheila J. Toro", url: "https://commons.wikimedia.org/wiki/File:Scleral_Icterus.jpg" } },
  "clm-avc-isquemico-tc-real": { id: "clm-avc-isquemico-tc-real", titulo: "AVC isquêmico — tomografia", legenda: "Hipodensidade em território de artéria cerebral média à tomografia de crânio sem contraste, achado de AVC isquêmico.", imagem: { src: "img/clinicas/avc-isquemico-tc.jpg", alt: "Tomografia de crânio com área de hipodensidade por AVC isquêmico de artéria cerebral média", fonte: "Wikimedia Commons", licenca: "CC BY-SA 4.0", autor: "0475ramosk", url: "https://commons.wikimedia.org/wiki/File:1-s2.0-S0967586810002766-gr2.jpg" } },
  "clm-fibrilacao-atrial-ecg-real": { id: "clm-fibrilacao-atrial-ecg-real", titulo: "Fibrilação atrial — eletrocardiograma", legenda: "Traçado de ECG com ausência de ondas P organizadas e intervalos R-R irregulares, característico de fibrilação atrial.", imagem: { src: "img/clinicas/fibrilacao-atrial-ecg.jpg", alt: "Traçado de eletrocardiograma mostrando fibrilação atrial, sem ondas P e com RR irregular", fonte: "Wikimedia Commons", licenca: "CC BY-SA 3.0", autor: "Michael Rosengarten, MD (CardioNetworks ECGpedia)", url: "https://commons.wikimedia.org/wiki/File:E0003168_(CardioNetworks_ECGpedia).jpg" } },
};
