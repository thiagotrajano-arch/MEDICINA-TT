...
export const QUESTOES_MFC: Questao[] = [
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "C", texto: "Odds Ratio multiplicado por 100.", correta: false, comentario: "Não há relação matemática desse tipo entre OR e NNT." },
  ...
  // ── TEMA 03 · SENSIBILIDADE E ESPECIFICIDADE ────────────────────
  {
    ...
    alternativas: [
      { letra: "A", texto: "Proporção de sadios corretamente identificados como negativos.", correta: false, comentario: "Essa é a definição de especificidade (verdadeiros negativos entre os sadios)." },
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "D", texto: "Substituem completamente a necessidade de sensibilidade e especificidade.", correta: false, comentario: "São complementares, não substitutos — servem propósitos diferentes na avaliação diagnóstica." },
    ],
    dificuldade: "intermediaria",
    estilo: "fixacao",
