...
export const QUESTOES_CARDIO: Questao[] = [
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "A = descendente; B = ascendente", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. Stanford A: envolve ascendente (qualquer extensao) — CIRURGIA. Stanford B: poupa ascendente (inicia apos subclavia E) — CLINICO na maioria." },
      { letra: "C", texto: "A = com IAo aguda; B = sem IAo", correta: false, comentario: "Esta opção diverge da diretriz atual. Stanford A: envolve ascendente (qualquer extensao) — CIRURGIA. Stanford B: poupa ascendente (inicia apos subclavia E) — CLINICO na maioria." },
      { letra: "D", texto: "A = jovem; B = idoso", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. Stanford A: envolve ascendente (qualquer extensao) — CIRURGIA. Stanford B: poupa ascendente (inicia apos subclavia E) — CLINICO na maioria." },
    ],
    dificuldade: "fixacao",
    estilo: "fixacao",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "B", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. DeBakey I (ascendente + arco + descendente) = Stanford A. DeBakey II (so ascendente) = Stanford A. DeBakey III (descendente) = Stanford B." },
      { letra: "C", texto: "A ou B, depende", correta: false, comentario: "Esta opção diverge da diretriz atual. DeBakey I (ascendente + arco + descendente) = Stanford A. DeBakey II (so ascendente) = Stanford A. DeBakey III (descendente) = Stanford B." },
      { letra: "D", texto: "Nenhuma", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. DeBakey I (ascendente + arco + descendente) = Stanford A. DeBakey II (so ascendente) = Stanford A. DeBakey III (descendente) = Stanford B." },
    ],
    dificuldade: "fixacao",
    estilo: "fixacao",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "So ocorre em cardiopatas", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. Holiday heart = FA (ou outras arritmias supraventriculares) precipitada por libacao alcoolica aguda. Costuma reverter espontaneamente com abstinencia." },
      { letra: "C", texto: "E sempre TV", correta: false, comentario: "Esta opção diverge da diretriz atual. Holiday heart = FA (ou outras arritmias supraventriculares) precipitada por libacao alcoolica aguda. Costuma reverter espontaneamente com abstinencia." },
      { letra: "D", texto: "Requer CDI", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. Holiday heart = FA (ou outras arritmias supraventriculares) precipitada por libacao alcoolica aguda. Costuma reverter espontaneamente com abstinencia." },
    ],
    dificuldade: "fixacao",
    estilo: "fixacao",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      { letra: "A", texto: "Doenca arterial coronariana", correta: false, comentario: "Em atletas com menos de 35 anos, a DAC é menos provável como causa principal; a cardiomiopatia hipertrófica lidera as causas estruturais." },
      { letra: "B", texto: "Cardiomiopatia hipertrofica", correta: true, comentario: "A cardiomiopatia hipertrófica é uma das causas mais comuns de morte súbita em atletas jovens, por arritmias ventriculares durante o esforço." },
      { letra: "C", texto: "Miocardite", correta: false, comentario: "Miocardite pode causar arritmias e morte súbita, mas não é a causa mais comum nesse grupo etário de atletas." },
      { letra: "D", texto: "Sindrome do QT longo", correta: false, comentario: "A síndrome do QT longo é uma causa hereditária importante, porém menos frequente que a cardiomiopatia hipertrófica nesse cenário." },
    ],
    dificuldade: "fixacao",
    estilo: "fixacao",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "Diminui", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. CMH obstrutiva AUMENTA com Valsalva (esvazia o VE, obstrucao piora). Estenose aortica valvar DIMINUI. Discriminador semiologico chave." },
      { letra: "C", texto: "Nao muda", correta: false, comentario: "Esta opção diverge da diretriz atual. CMH obstrutiva AUMENTA com Valsalva (esvazia o VE, obstrucao piora). Estenose aortica valvar DIMINUI. Discriminador semiologico chave." },
      { letra: "D", texto: "Some completamente", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. CMH obstrutiva AUMENTA com Valsalva (esvazia o VE, obstrucao piora). Estenose aortica valvar DIMINUI. Discriminador semiologico chave." },
    ],
    dificuldade: "fixacao",
    estilo: "fixacao",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: ">=135x85", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. MAPA 24h: >=130x80. Vigilia: >=135x85. Sono: >=120x70. Consultorio: >=140x90. MRPA: >=130x80." },
      { letra: "C", texto: ">=140x90", correta: false, comentario: "Esta opção diverge da diretriz atual. MAPA 24h: >=130x80. Vigilia: >=135x85. Sono: >=120x70. Consultorio: >=140x90. MRPA: >=130x80." },
      { letra: "D", texto: ">=125x75", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. MAPA 24h: >=130x80. Vigilia: >=135x85. Sono: >=120x70. Consultorio: >=140x90. MRPA: >=130x80." },
    ],
    dificuldade: "fixacao",
    estilo: "fixacao",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "So aumento de diuretico", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. TRC (biventricular) tem indicacao mais forte com BRE + QRS >=150ms + FE <=35% + NYHA II-III sintomatica sob terapia otimizada. Reduz mortalidade." },
      { letra: "C", texto: "Digoxina", correta: false, comentario: "Esta opção diverge da diretriz atual. TRC (biventricular) tem indicacao mais forte com BRE + QRS >=150ms + FE <=35% + NYHA II-III sintomatica sob terapia otimizada. Reduz mortalidade." },
      { letra: "D", texto: "Sacubitril-valsartana", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. TRC (biventricular) tem indicacao mais forte com BRE + QRS >=150ms + FE <=35% + NYHA II-III sintomatica sob terapia otimizada. Reduz mortalidade." },
    ],
    dificuldade: "fixacao",
    estilo: "fixacao",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "Vascular so ocorre em jovens", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. Vascular ALIVIA parando em pe (basta cessar o esforco muscular). Neurogenica exige FLEXAO (abre o canal lombar). Paciente com estenose de canal tolera bicicleta. Pulsos e ITB normais na neurogenica." },
      { letra: "C", texto: "Neurogenica sempre tem ITB baixo", correta: false, comentario: "Esta opção diverge da diretriz atual. Vascular ALIVIA parando em pe (basta cessar o esforco muscular). Neurogenica exige FLEXAO (abre o canal lombar). Paciente com estenose de canal tolera bicicleta. Pulsos e ITB normais na neurogenica." },
      { letra: "D", texto: "Nao ha como diferenciar clinicamente", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. Vascular ALIVIA parando em pe (basta cessar o esforco muscular). Neurogenica exige FLEXAO (abre o canal lombar). Paciente com estenose de canal tolera bicicleta. Pulsos e ITB normais na neurogenica." },
    ],
    dificuldade: "fixacao",
    estilo: "fixacao",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "Repolarizacao precoce, alta ambulatorial", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. Wellens tipo A (T bifasica) em V2-V3 = suboclusao critica de descendente anterior. TE ergometrico e CONTRAINDICADO (pode desencadear IAM anterior extenso). Cateterismo direto." },
      { letra: "C", texto: "Pericardite viral, AINE + colchicina", correta: false, comentario: "Esta opção diverge da diretriz atual. Wellens tipo A (T bifasica) em V2-V3 = suboclusao critica de descendente anterior. TE ergometrico e CONTRAINDICADO (pode desencadear IAM anterior extenso). Cateterismo direto." },
      { letra: "D", texto: "IAM sem supra Killip I, alta com AAS", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. Wellens tipo A (T bifasica) em V2-V3 = suboclusao critica de descendente anterior. TE ergometrico e CONTRAINDICADO (pode desencadear IAM anterior extenso). Cateterismo direto." },
    ],
    dificuldade: "intermediaria",
    estilo: "caso",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "Manter esmolol", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. Broncoespasmo grave + necessidade de reducao de dP/dt = BCC nao di-idropiridinico IV (diltiazem/verapamil). Sao a alternativa quando BB e contraindicado." },
      { letra: "C", texto: "Suspender toda a terapia", correta: false, comentario: "Esta opção diverge da diretriz atual. Broncoespasmo grave + necessidade de reducao de dP/dt = BCC nao di-idropiridinico IV (diltiazem/verapamil). Sao a alternativa quando BB e contraindicado." },
      { letra: "D", texto: "Trocar por betabloqueador seletivo VO", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. Broncoespasmo grave + necessidade de reducao de dP/dt = BCC nao di-idropiridinico IV (diltiazem/verapamil). Sao a alternativa quando BB e contraindicado." },
    ],
    dificuldade: "intermediaria",
    estilo: "caso",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "Xantomatose isolada, sem impacto familiar", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. Xantoma tendineo + LDL muito alto + historia familiar precoce = HIPERCOLESTEROLEMIA FAMILIAR. Rastreamento familiar em cascata (incluindo criancas) e obrigatorio." },
      { letra: "C", texto: "Doenca de Wilson", correta: false, comentario: "Esta opção diverge da diretriz atual. Xantoma tendineo + LDL muito alto + historia familiar precoce = HIPERCOLESTEROLEMIA FAMILIAR. Rastreamento familiar em cascata (incluindo criancas) e obrigatorio." },
      { letra: "D", texto: "Hipotireoidismo — dosar TSH e nao rastrear familiares", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. Xantoma tendineo + LDL muito alto + historia familiar precoce = HIPERCOLESTEROLEMIA FAMILIAR. Rastreamento familiar em cascata (incluindo criancas) e obrigatorio." },
    ],
    dificuldade: "intermediaria",
    estilo: "caso",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "Trocar losartana por sacubitril-valsartana", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. HAR verdadeira -> 4a droga = ESPIRONOLACTONA (PATHWAY-2). Monitorar K e creatinina em 1-2 semanas. Cautela se ClCr 4,5." },
      { letra: "C", texto: "Adicionar clonidina", correta: false, comentario: "Esta opção diverge da diretriz atual. HAR verdadeira -> 4a droga = ESPIRONOLACTONA (PATHWAY-2). Monitorar K e creatinina em 1-2 semanas. Cautela se ClCr 4,5." },
      { letra: "D", texto: "Suspender hidroclorotiazida", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. HAR verdadeira -> 4a droga = ESPIRONOLACTONA (PATHWAY-2). Monitorar K e creatinina em 1-2 semanas. Cautela se ClCr 4,5." },
    ],
    dificuldade: "intermediaria",
    estilo: "caso",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "Perfil C — inotropico", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. EAP hipertensivo = perfil B com componente hipertensivo intenso. Tratamento: diuretico + nitroglicerina IV (venovasodilatacao) + VNI (reduz trabalho respiratorio e mortalidade). Nao intubar de imediato salvo falha." },
      { letra: "C", texto: "Perfil L — expansao volemica", correta: false, comentario: "Esta opção diverge da diretriz atual. EAP hipertensivo = perfil B com componente hipertensivo intenso. Tratamento: diuretico + nitroglicerina IV (venovasodilatacao) + VNI (reduz trabalho respiratorio e mortalidade). Nao intubar de imediato salvo falha." },
      { letra: "D", texto: "Perfil A — alta hospitalar", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. EAP hipertensivo = perfil B com componente hipertensivo intenso. Tratamento: diuretico + nitroglicerina IV (venovasodilatacao) + VNI (reduz trabalho respiratorio e mortalidade). Nao intubar de imediato salvo falha." },
    ],
    dificuldade: "intermediaria",
    estilo: "caso",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "Aumentar diuretico apenas", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. INRA e superior a IECA (PARADIGM-HF). BRE + QRS >=150ms + FE <=35% + NYHA II-III = TRC (indicacao classe I). Como FE <=35%, prevencao primaria com CDI tambem indicada (TRC-D)." },
      { letra: "C", texto: "So aguardar melhora", correta: false, comentario: "Esta opção diverge da diretriz atual. INRA e superior a IECA (PARADIGM-HF). BRE + QRS >=150ms + FE <=35% + NYHA II-III = TRC (indicacao classe I). Como FE <=35%, prevencao primaria com CDI tambem indicada (TRC-D)." },
      { letra: "D", texto: "Digoxina", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. INRA e superior a IECA (PARADIGM-HF). BRE + QRS >=150ms + FE <=35% + NYHA II-III = TRC (indicacao classe I). Como FE <=35%, prevencao primaria com CDI tambem indicada (TRC-D)." },
    ],
    dificuldade: "intermediaria",
    estilo: "caso",
    tags: [],
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "Anticoagular mais", correta: false, comentario: "Esta alternativa não corresponde à conduta recomendada. Anticoagulante oral em pericardite com derrame = risco de hemopericardio. Preditor de mau prognostico (indica internar). Individualizar suspensao (peso: risco embolico da FA vs risco hemorragico). Reversao completa com AINE+colchicina antes de reintroduzir." },
      { letra: "C", texto: "Trombolisar", correta: false, comentario: "Esta opção diverge da diretriz atual. Anticoagulante oral em pericardite com derrame = risco de hemopericardio. Preditor de mau prognostico (indica internar). Individualizar suspensao (peso: risco embolico da FA vs risco hemorragico). Reversao completa com AINE+colchicina antes de reintroduzir." },
      { letra: "D", texto: "Iniciar heparina em dose plena", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. Anticoagulante oral em pericardite com derrame = risco de hemopericardio. Preditor de mau prognostico (indica internar). Individualizar suspensao (peso: risco embolico da FA vs risco hemorragico). Reversao completa com AINE+colchicina antes de reintroduzir." },
    ],
    dificuldade: "intermediaria",
    estilo: "caso",
    tags: [],
