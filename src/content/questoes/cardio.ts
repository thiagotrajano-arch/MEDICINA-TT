...
export const QUESTOES_CARDIO: Questao[] = [
  ...
  },
  {
    ...
    alternativas: [
      ...
      { letra: "B", texto: "Cardiomiopatia hipertrofica", correta: true, comentario: "Esta alternativa não corresponde à conduta recomendada. Jovem =35 anos: DAC domina." },
      { letra: "C", texto: "Miocardite", correta: false, comentario: "Esta opção diverge da diretriz atual. Jovem =35 anos: DAC domina." },
      { letra: "D", texto: "Sindrome do QT longo", correta: false, comentario: "Esta resposta não reflete o padrão-ouro. Jovem =35 anos: DAC domina." },
    ],
    dificuldade: "fixacao",
    estilo: "fixacao",
    tags: [],
